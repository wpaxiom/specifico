    ...
    return (
        <div className="flex items-center w-full min-h-11 py-4">
            <div className="flex items-center gap-7 w-full">
                ...
                <select id={id} name={id} {...rest} className={ hasLabel ? "w-[80%] specifico-field-control !bg-[#fbfcfd] !border !border-[#F0F0FE] focus:!border-[#C9C7FB] focus:!outline-none focus:!shadow-none focus:!ring-0 !rounded !py-2 !px-5 !leading-none !max-w-full box-border appearance-none !bg-caret !bg-[length:8px_4px] !bg-[right_12px_top_50%] !text-[#555555]" + ' ' + className : "w-full specifico-field-control !bg-[#fbfcfd] !border !border-[#F0F0FE] focus:!border-[#C9C7FB] focus:!outline-none focus:!shadow-none focus:!ring-0 !rounded !py-2 !px-5 !leading-none !max-w-full box-border appearance-none !bg-caret !bg-[length:8px_4px] !bg-[right_12px_top_50%] !text-[#555555]" + ' ' + className} >
                    {items.map((item) => (
